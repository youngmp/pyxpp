...
void auto_plot_par()
{
  printf("OPENED WINDOW auto_plot_par");
...
void do_auto_win()
{
  ...
  if(Auto.exist==0){
    ...
    make_auto("It's AUTO man! Yes!","AUTO");
    Auto.exist=1;
  }
}
...
void do_auto_py(iold,isave,itp)
  int iold,isave;
int itp;
{
  //redraw_auto_menus();
  ...
  open_auto(iold); /* this copies the relevant files .s  to fort.3 */
  go_go_auto_py();
  /* this complets the initialization and calls the 
		   main routines 
		*/
  /* plintf("AUTO opened it==%d\n",itp); */
  /*     run_aut(Auto.nfpar,itp); THIS WILL CHANGE TO gogoauto stuff */ 
  //close_auto(isave);
  /* this copies fort.8 to the .s file and other 
			irrelevant stuff 
		     */
