...

{
  ...
  cnrlae_py(iap, rap, par, icp, funi, stpnt, pvli, thl, thu, iuz, vuz);
  return 0;
} 
...
/* Subroutine */ int 
cnrlae_py(iap_type *iap, rap_type *rap, doublereal *par, integer *icp, FUNI_TYPE((*funi)), STPNT_TYPE_AE((*stpnt)), PVLI_TYPE_AE((*pvli)), doublereal *thl, doublereal *thu, integer *iuz, doublereal *vuz)
{
...
/* Local */
  ...
  stplae_py(iap, rap, par, icp, rlcur, u);
  istop = iap->istop;
